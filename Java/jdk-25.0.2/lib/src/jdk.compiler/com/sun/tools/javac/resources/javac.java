...
public final class javac extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "javac.opt.Xlint", "Enable recommended warning categories" },
            { "javac.opt.Xlint.all", "Enable all warning categories" },
            { "javac.opt.Xlint.custom", "Warning categories to enable or disable, separated by comma.\nPrecede a key by ''-'' to disable the specified warning.\nUse --help-lint to see the supported keys." },
            ...
            { "javac.opt.Xlint.none", "Disable all warning categories" },
