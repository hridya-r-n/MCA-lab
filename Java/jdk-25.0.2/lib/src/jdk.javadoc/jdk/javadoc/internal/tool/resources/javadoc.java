...
public final class javadoc extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "main.did-you-mean", "Did you mean: {0}" },
            { "main.did-you-mean-one-of", "Did you mean one of: {0}" },
            ...
            { "main.for-more-details-see-usage", "For more details on available options, use --help or --help-extra" },
            ...
            { "main.opt.disable.line.doc.comments.desc", "Disable support for documentation comments with lines\nbeginning '///'" },
            ...
            { "main.opt.show.packages.desc", "Specifies which module packages will be documented. Possible\nvalues are \"exported\" or \"all\" packages." },
