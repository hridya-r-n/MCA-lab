...
public final class jar extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "error.extract.multiple.dest.dir", "You may not specify the '-C' or '--dir' option more than once with the '-x' option" },
            { "error.extract.pflag.not.allowed", "You may not specify '-Px' with the '-C' or '--dir' options" },
            ...
            { "error.release.value.toohigh.versioned.entry", "{0} has class file version {1}, but class file version {2} or less is required to target release {3} of the Java Platform" },
            ...
            { "main.help.opt.extract.dir", "  --dir                    Directory into which the jar will be extracted" },
            ...
            { "out.extract.dir", "extracting to directory: {0}" },
            ...
            { "warn.validator.cen.only.entry", "Warning: An equivalent for the central directory entry {0} was not found in the local file headers" },
            ...
            { "warn.validator.duplicate.cen.entry", "Warning: There were {0} central directory entries found for {1}" },
            { "warn.validator.duplicate.loc.entry", "Warning: There were {0} local file headers found for {1}" },
            { "warn.validator.identical.entry", "Warning: entry {0} contains a class that\nis identical to an entry already in the jar" },
            { "warn.validator.invalid.entry.name", "Warning: entry name {0} is not valid" },
            { "warn.validator.loc.only.entry", "Warning: An equivalent entry for the local file header {0} was not found in the central directory" },
            { "warn.validator.order.mismatch", "Warning: Central directory and local file header entries are not in the same order" },
